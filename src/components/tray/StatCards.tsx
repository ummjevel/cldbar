...
import { ArrowUpRight, ArrowDownLeft, MessageSquare, Layers, DollarSign } from "lucide-react";
...
/** All-time totals for the profile, one fact per card. */
  ...
  const cards = [
    {
      ...
      // Input is what the user sends out to the model.
      icon: ArrowUpRight,
      color: colors.main,
      tooltip: "All-time tokens sent to the model",
    },
    {
      label: "Output",
      ...
      icon: ArrowDownLeft,
      color: colors.light,
      tooltip: "All-time tokens generated by the model",
    },
    ...(isApi
      ? [
          {
      ...
      : [
          {
            ...
            icon: Layers,
            color: "var(--color-muted)",
            tooltip: "All-time coding sessions",
          },
          {
            label: "Messages",
            ...
            icon: MessageSquare,
            color: "var(--color-muted)",
            tooltip: "All-time messages exchanged",
          },
        ]),
  ];
    ...
    <div className="grid grid-cols-2 gap-2">
      {cards.map((card, i) => (
        <motion.div
          ...
          onFocus={() => setHoveredCard(card.label)}
        ...
        >
          ...
          <div className="flex items-center justify-between mb-1.5">
            ...
            <card.icon size={12} style={{ color: card.color }} className="opacity-60" aria-hidden="true" />
          </div>
